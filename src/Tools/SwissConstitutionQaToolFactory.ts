...
export class SwissConstitutionQaToolFactory {
    ...
    async create(): Promise<ChainTool> {
        ...
        return new ChainTool({
            ...
            description: 'Use to read the Swiss constitution and do research in it. Important: You MUST use this tool before answering any questions about the constitution. Input should be a fully formed question.',
            chain,
        });
    }
}