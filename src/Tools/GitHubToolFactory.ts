...
export class GitHubToolFactory {
    ...
    async create(): Promise<ChainTool> {
        ...
        return new ChainTool({
            name: 'github-qa',
            description: 'Use to answer questions about your source code in your GitHub repository. Input should be a fully formed question that does not mention GitHub.',
            chain,
        });
    }
}